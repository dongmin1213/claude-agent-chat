...
[Claude Agent SDK](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk) 기반의 데스크톱 채팅 앱.
브라우저(Next.js) 또는 Windows exe(Electron)로 실행 가능.

> Desktop chat app powered by [Claude Agent SDK](https://www.npmjs.com/package/@anthropic-ai/claude-agent-sdk).
> Run in browser (Next.js) or as a Windows desktop app (Electron).
